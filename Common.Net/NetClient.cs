    ...
    public class NetClient
    {
       ...
       /// </summary>
        ...
        public NetClient()
        {
            ...
            {                
                MakeExceptionEvent(ex, "NetClient");
            }
        }
        ...
        public bool StartServer(IPAddress ip, int port)
        {
            try
            {
                ...
                MakeLinkMessageEvent("开始连接", NetState.StartLink);
        ...
        private void ConnectedFinalCallback(IAsyncResult ar)
        {
            ...
            {
                MakeExceptionEvent(e, "ConnectedFinalCallback");
                isRun = false;
                MakeLinkMessageEvent("连接失败", NetState.Stop);
